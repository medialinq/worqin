...
2. `.claude/agents/TECH.md` sectie 10 — business logic functies (testbaar)
...
Na tests: `pnpm test` groen, update `.claude/agents/TODO.md`, commit: `test([scope]): beschrijving`
