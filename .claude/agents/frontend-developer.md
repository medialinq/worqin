...
1. `.claude/agents/CLAUDE.md` — harde regels en conventies
2. `.claude/agents/DESIGN.md` — **leidend voor alle visuele beslissingen**
3. `.claude/agents/PLAN.md` sectie 5 — schermen en states per module
...
Update `.claude/agents/TODO.md` — zet voltooide taken op `[x]`.
