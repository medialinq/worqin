...
1. `agents/CLAUDE.md` — harde regels, stack, conventies
2. `agents/TODO.md` — huidige status
3. `agents/PLAN.md` — scope, features, roadmap
4. `agents/TECH.md` — alleen als je een backend sprint plant
5. `agents/DESIGN.md` — alleen als je een frontend sprint plant
...
6. **Update** `agents/TODO.md` na elke sprint
...
Branch: feature/[naam]
Bronbestanden: agents/DESIGN.md sectie X, agents/PLAN.md sectie Y
...
Branch: feature/[naam]
Bronbestanden: agents/TECH.md sectie X
Wat: [omschrijving]
...
Bronbestanden: `agents/DESIGN.md` secties 1-4, `agents/PLAN.md` sectie 6
Wat exact bouwen:
