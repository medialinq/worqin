...
2. `agents/TECH.md` sectie 14 — environment variables
...
Zie `agents/TECH.md` sectie 14 voor de volledige lijst.
...
Na wijziging: verifieer deployment, SSL actief. Update `agents/TODO.md`.
